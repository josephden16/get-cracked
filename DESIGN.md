...
- Pure black primary (`#000000`) — cold, clean terminal background
...
- **OpenCode Dark** (`#000000`): Primary background, button fills, link text. Pure black with no warm undertone.
...
- **Dark Surface** (`#111111`): Slightly lighter than primary dark, used for elevated surfaces and subtle differentiation.
